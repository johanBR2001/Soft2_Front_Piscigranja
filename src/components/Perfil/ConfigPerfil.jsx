...
function Configperfil() {
    ...
    return <div className="perfil">
        ...
        <div className="overlap">
          ...
          <div className="text-wrapper-5">Administrador</div>
                ...
                {/* <div class="card col-lg-8 formulario">
                    ...
                    <div  className="rectangle-2">
                     ...
                     <div className="text-wrapper-6" onClick={datos}>Datos Personales</div>
          
          <div className="text-wrapper-14" onClick={compañia_datos}>Compañia</div>
          ...
          <input className="rectangle-6"  type="text" disabled value={email}/>
          ...
          <button onClick={handleSubmit} className="text-wrapper-16">Actualizar</button>
                        ...
                        <div className="text-wrapper-7">Compania</div>
          
          <div className="text-wrapper-13">nruc</div>
          <div className="text-wrapper-8">Direccion</div>
          <div className="text-wrapper-9">Telefono</div>
          <div className="text-wrapper-10">Ciudad</div>
          <div className="text-wrapper-11">Pais</div>
